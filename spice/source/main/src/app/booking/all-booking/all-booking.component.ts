...
export class AllbookingComponent implements OnInit {
  ...
  exampleDatabase?: BookingService;
  ...
  exportExcel() {
    ...
    const exportData: Partial<TableElement>[] =
      this.dataSource.filteredData.map((x) => ({
        ...
        Mobile: x.mobile,
        Email: x.email,
        Arrive: formatDate(new Date(x.arriveDate), 'yyyy-MM-dd', 'en') || '',
        Depart: formatDate(new Date(x.departDate), 'yyyy-MM-dd', 'en') || '',
